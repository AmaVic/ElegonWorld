...
void AddCustomScripts()
{
	...
	AddSC_GuildScript_script();
	AddSC_script_ffa_mastodonte();
	AddSC_Vegetable_script();
	AddSC_boutique_script();
	AddSC_ScriptWarSytem();
	AddSC_Lottery_script();
	AddSC_BountyHunter();
	AddSC_REFORGER_NPC();
	AddSC_script_ks();
	AddSC_script_ffa_mastodonte();
	AddSC_script_debug_cmd_raid();
	AddSC_script_npc_raid();
	AddSC_script_rgm_decoplayer();
	AddSC_script_cmd_income();
	AddSC_script_cac_icw();
	AddSC_script_npc_LoL();
	AddSC_script_debug_rift();
	AddSC_script_run_rift();
	AddSC_script_rift_creature();
	AddSC_script_boss_zg1();
	AddSC_script_parrainage();
	AddSC_scripts_sponsorship();
	AddSC_Fishing_tournament();
	AddSC_npc_classement_loe();
	AddSC_npc_info_rift();
	AddSC_npc_classement_bg_all();
	AddSC_script_remove_character();
	AddSC_TheramorNPC();
	AddSC_script_grades();
	AddSC_Npc_Beastmaster();
	AddSC_scripts_items_campzg();
	AddSC_grades_pve();
	AddSC_capture_flags_script();
	AddSC_item_script_teleport();
	AddSC_PresentationOfTheServer();
	AddSC_Premium_script();
#endif
}
