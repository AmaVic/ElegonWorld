    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
            ...
            case 69846: // Frost Bomb
                ...
                break;
			case 22436 : // Armure de feu
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(9); // 30 secondes
				break;
			case 70274: // Armure de feu
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(23); // 30 secondes
				break;
			case 120159: // Armure de feu
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(23); // 30 secondes
				break;
			case 9616: // Armure de feu
				spellInfo->CastTimeEntry = sSpellCastTimesStore.LookupEntry(7);
				break;
			case 41056: // Armure de feu
				spellInfo->CastTimeEntry = sSpellCastTimesStore.LookupEntry(7);
				break;
			case 120155: // Armure de feu
				spellInfo->CastTimeEntry = sSpellCastTimesStore.LookupEntry(6);
				break;
			case 42384: // Armure de feu
				spellInfo->CastTimeEntry = sSpellCastTimesStore.LookupEntry(6);
				break;
			case 120152: // Armure de feu
				spellInfo->CastTimeEntry = sSpellCastTimesStore.LookupEntry(6);
				break;
			case 120158: // Armure de feu
				spellInfo->CastTimeEntry = sSpellCastTimesStore.LookupEntry(7);
				break;
			case 41107: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(9); // 30 secondes
				break;
			case 120140: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(9); // 30 secondes
				break;
			case 120141: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(9); // 30 secondes
				break;
			case 71953: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(23); // 90 secondes
				break;
			case 62055: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(63); // 90 secondes
				break;
			case 40733: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(1); // 10 secondes
				break;
			case 6634: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(27); // 10 secondes
				break;

			case 61964: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(27); // 10 secondes
				break;
			case 85000: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(42); // 10 secondes
				break;
			case 900050: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(580); // 10 secondes
				break;
			case 1000000: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(347); // 10 secondes
				break;
			case 1000001: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(347); // 10 secondes
				break;
			case 1000002: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(347); // 10 secondes
				break;
			case 96200: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(347); // 10 secondes
				break;
			case 96201: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(347); // 10 secondes
				break;
			case 96203: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(347); // 10 secondes
				break;
			case 59366: // Berserker
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(347); // 10 secondes
				break;
			case 62598:
				spellInfo->CastTimeEntry = sSpellCastTimesStore.LookupEntry(12);
				break;
            case 71614: // Ice Lock
			...
			case 120138:
				...
				break;
			case 120139:
				spellInfo->CastTimeEntry = sSpellCastTimesStore.LookupEntry(27);
				break;
			case 65816:
				spellInfo->CastTimeEntry = sSpellCastTimesStore.LookupEntry(7);
				break;
            ...
            case 72743: // Defile
                ...
                break;
			case 62363:
				spellInfo->Effects[EFFECT_1].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_1_YARD); // 10yd
				break;
			case 67706:
				spellInfo->Effects[EFFECT_1].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_0_5_YARDS); // 10yd
				break;
            case 72754: // Defile
            case 73708: // Defile
            case 73709: // Defile
