...
#include "BattlegroundICW.h" //CUSTOM: ICW
#include "Chat.h"
#include "Map.h"
...
Battleground* BattlegroundMgr::CreateNewBattleground(BattlegroundTypeId originalBgTypeId, PvPDifficultyEntry const* bracketEntry, uint8 arenaType, bool isRated)
{
    ...
    switch (bgTypeId)
    {
		...
		case BATTLEGROUND_ICW: //CUSTOM: ICW
			bg = new BattlegroundICW(*(BattlegroundICW*)bg_template);
			break;
        default:
            return NULL;
    }
...
bool BattlegroundMgr::CreateBattleground(CreateBattlegroundData& data)
{
    ...
    switch (data.bgTypeId)
    {
        ...
        case BATTLEGROUND_RB:
            ...
            bg->SetRandom(true);
            break;
		case BATTLEGROUND_ICW:
			bg = new BattlegroundICW();
			break;
        default:
            return false;
    }
...
BattlegroundTypeId BattlegroundMgr::BGTemplateId(BattlegroundQueueTypeId bgQueueTypeId)
{
    switch (bgQueueTypeId)
    {
		...
		case BATTLEGROUND_QUEUE_ICW: //CUSTOM: ICW
			return BATTLEGROUND_ICW;
