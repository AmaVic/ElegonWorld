...
enum RBACPermissions
{
	...
	//CUSTOM: RGM
	RBAC_PERM_COMMAND_OUI = 778,
	RBAC_PERM_COMMAND_NON = 779,
	//CUSTOM: RIFT
	RBAC_PERM_COMMAND_RESTOREITEM = 780,
	RBAC_PERM_COMMAND_START_RIFT = 800,
	RBAC_PERM_COMMAND_CLOSE_RIFT = 781,
	//CUSTOM: SPONSORSHIP
	RBAC_PERM_COMMAND_SPONSORSHIP = 782,
	RBAC_PERM_COMMAND_SPONSORSHIP_TELE = 783,
	RBAC_PERM_COMMAND_SPONSORSHIP_INFOS = 784,
	//CUSTOM: FFA Rankings
	RBAC_PERM_COMMAND_FFA_RANKING = 785,
