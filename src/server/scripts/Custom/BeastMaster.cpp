...
public:
	...
	void CreatePet(Player *player, Creature * m_creature, uint32 entry) {
		...
		if (player->getClass() != CLASS_HUNTER) {
			m_creature->MonsterWhisper("Vous n'etes pas un chasseur", player);
			player->PlayerTalkClass->SendCloseGossip();
			return;
		}

		if (player->GetPet()) {
			m_creature->MonsterWhisper("Retirer d'abord votre pet!", player);
			player->PlayerTalkClass->SendCloseGossip();
			return;
		}
	...
	bool OnGossipHello(Player *player, Creature * m_creature)
	{
		...
		player->ADD_GOSSIP_ITEM(4, "J'aimerais un nouveau animal", GOSSIP_SENDER_MAIN, 30);
		if (player->CanTameExoticPets())
		{
			player->ADD_GOSSIP_ITEM(4, "J'aimerais un nouveau animal exotique", GOSSIP_SENDER_MAIN, 50);
		}
		player->ADD_GOSSIP_ITEM(5, "Fermer", GOSSIP_SENDER_MAIN, 150);
	...
	bool OnGossipSelect(Player *player, Creature * m_creature, uint32 sender, uint32 action)
	{
		...
		case 150:
			...
			break;
		case 30:
			player->ADD_GOSSIP_ITEM(2, "Retour au menu principal", GOSSIP_SENDER_MAIN, 100);
			player->ADD_GOSSIP_ITEM(4, "Page suivante", GOSSIP_SENDER_MAIN, 31);
			player->ADD_GOSSIP_ITEM(6, "Chauffe souris", GOSSIP_SENDER_MAIN, 18);
			player->ADD_GOSSIP_ITEM(6, "Ours", GOSSIP_SENDER_MAIN, 1);
			player->ADD_GOSSIP_ITEM(6, "Sanglier", GOSSIP_SENDER_MAIN, 2);
			player->ADD_GOSSIP_ITEM(6, "Tigre", GOSSIP_SENDER_MAIN, 4);
			player->ADD_GOSSIP_ITEM(6, "Crabe", GOSSIP_SENDER_MAIN, 6);
			...
			player->ADD_GOSSIP_ITEM(6, "Heyne", GOSSIP_SENDER_MAIN, 10);
			player->ADD_GOSSIP_ITEM(6, "Papillons", GOSSIP_SENDER_MAIN, 11);
			player->ADD_GOSSIP_ITEM(6, "Hiboux", GOSSIP_SENDER_MAIN, 12);
			player->SEND_GOSSIP_MENU(1, m_creature->GetGUID());
			break;

		case 31:
			player->ADD_GOSSIP_ITEM(2, "Retour", GOSSIP_SENDER_MAIN, 30);
			player->ADD_GOSSIP_ITEM(6, "Raptor", GOSSIP_SENDER_MAIN, 20);
			player->ADD_GOSSIP_ITEM(6, "Ravager", GOSSIP_SENDER_MAIN, 19);
			player->ADD_GOSSIP_ITEM(6, "Scorpion", GOSSIP_SENDER_MAIN, 414);
			player->ADD_GOSSIP_ITEM(6, "Araignee", GOSSIP_SENDER_MAIN, 16);
			player->ADD_GOSSIP_ITEM(6, "Serpent", GOSSIP_SENDER_MAIN, 21);
			player->ADD_GOSSIP_ITEM(6, "Tortue", GOSSIP_SENDER_MAIN, 15);
			player->ADD_GOSSIP_ITEM(6, "Abeille", GOSSIP_SENDER_MAIN, 93);
			player->SEND_GOSSIP_MENU(1, m_creature->GetGUID());
			break;

		case 50:
			player->ADD_GOSSIP_ITEM(2, "Retour au menu principal", GOSSIP_SENDER_MAIN, 100);
			player->ADD_GOSSIP_ITEM(6, "Chimere", GOSSIP_SENDER_MAIN, 51);
			player->ADD_GOSSIP_ITEM(6, "chien du magma", GOSSIP_SENDER_MAIN, 52);
			player->ADD_GOSSIP_ITEM(6, "Devilsaure", GOSSIP_SENDER_MAIN, 53);
			player->ADD_GOSSIP_ITEM(6, "Rhino", GOSSIP_SENDER_MAIN, 54);
			player->ADD_GOSSIP_ITEM(6, "Silithid", GOSSIP_SENDER_MAIN, 55);
			player->ADD_GOSSIP_ITEM(6, "Vers", GOSSIP_SENDER_MAIN, 56);
