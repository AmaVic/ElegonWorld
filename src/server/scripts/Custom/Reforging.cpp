...
static const ItemModType statTypes[] = { ITEM_MOD_SPIRIT, ITEM_MOD_DODGE_RATING, ITEM_MOD_PARRY_RATING, ITEM_MOD_HIT_RATING, ITEM_MOD_CRIT_RATING, ITEM_MOD_HASTE_RATING, ITEM_MOD_EXPERTISE_RATING, ITEM_MOD_ARMOR_PENETRATION_RATING, ITEM_MOD_INTELLECT, };
...
static const char* GetStatName(uint32 ItemStatType)
{
	...
	case ITEM_MOD_MANA_REGENERATION: return "Mana toutes les 5 secondes"; break;
	case ITEM_MOD_ARMOR_PENETRATION_RATING: return "Penetration d'armure"; break;
	case ITEM_MOD_SPIRIT: return "Esprit"; break;
	case ITEM_MOD_DODGE_RATING: return "Esquive"; break;
	case ITEM_MOD_PARRY_RATING: return "Parade"; break;
	case ITEM_MOD_HIT_RATING: return "Score de toucher"; break;
	case ITEM_MOD_CRIT_RATING: return "Score de coup critique"; break;
	case ITEM_MOD_HASTE_RATING: return "Score de hate"; break;
	case ITEM_MOD_EXPERTISE_RATING: return "Score d'expertise"; break;
	default: return NULL;
...
static const char* GetSlotName(uint8 slot, WorldSession* session)
{
	switch (slot)
	{
	case EQUIPMENT_SLOT_HEAD: return "|TInterface/ICONS/Inv_helmet_09:20|t Tete";
	case EQUIPMENT_SLOT_NECK: return "|TInterface/ICONS/Inv_neck_hyjaldaily_04:20|t Collier";
	case EQUIPMENT_SLOT_SHOULDERS: return "|TInterface/ICONS/Inv_shoulder_04:20|t Epaulieres";
	case EQUIPMENT_SLOT_BODY: return "|TInterface/ICONS/Inv_belt_14:20|t Chemise";
	case EQUIPMENT_SLOT_CHEST: return "|TInterface/ICONS/Inv_chest_fur.:20|t Torse";
	case EQUIPMENT_SLOT_WAIST: return "|TInterface/ICONS/Inv_belt_14:20|t Ceinture";
	case EQUIPMENT_SLOT_LEGS: return "|TInterface/ICONS/Inv_pants_05:20|t Jambieres";
	case EQUIPMENT_SLOT_FEET: return "|TInterface/ICONS/Inv_boots_07:20|t Pieds";
	case EQUIPMENT_SLOT_WRISTS: return "|TInterface/ICONS/Inv_bracer_02:20|t Brassards";
	case EQUIPMENT_SLOT_HANDS: return "|TInterface/ICONS/Inv_weapon_glave_01:20|t Mains";
	case EQUIPMENT_SLOT_FINGER1: return "|TInterface/ICONS/Inv_misc_emeraldstonering:20|t Doigt gauche";
	case EQUIPMENT_SLOT_FINGER2: return "|TInterface/ICONS/Inv_misc_emeraldstonering:20|t Doigt droit";
	case EQUIPMENT_SLOT_TRINKET1: return "|TInterface/ICONS/Inv_bijou_gold:20|t Bijou gauche";
	case EQUIPMENT_SLOT_TRINKET2: return "|TInterface/ICONS/Inv_bijou_gold:20|t Bijou droit";
	case EQUIPMENT_SLOT_BACK: return "|TInterface/ICONS/Inv_misc_cape_23:20|t Dos";
	case EQUIPMENT_SLOT_MAINHAND: return "|TInterface/ICONS/Inv_weapon_glave_01:20|t Main droite";
	case EQUIPMENT_SLOT_OFFHAND: return "|TInterface/ICONS/Inv_weapon_glave_01:20|t Main gauche";
	case EQUIPMENT_SLOT_TABARD: return "|TInterface/ICONS/Inv_rareguildtabard:20|t Tabard";
	case EQUIPMENT_SLOT_RANGED: return "|TInterface/ICONS/Achievement_guildperk_mobilebanking:20|t Distances";
	default: return NULL;
	}
}
...
void RemoveReforge(Player* player, uint32 itemguid, bool update)
{
	...
	Item* invItem = update ? player->GetItemByGuid((HIGHGUID_ITEM, 0, itemguid)) : NULL;
	if (invItem)
	...
	void OnLogin(Player* player, bool firstLogin) override
	{
		...
		if (result)
		{
			do
			{
				...
				Item* invItem = player->GetItemByGuid((HIGHGUID_ITEM, 0, lowGUID));
				if (invItem)
					player->_ApplyItemMods(invItem, invItem->GetSlot(), false);
...
public:
	...
	{
		player->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Voici la liste des objets que vous pouvez retoucher.", 0, Melt(MAIN_MENU, 0));
		...
		player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Retirer une reforge", 0, Melt(SELECT_RESTORE, 0));
	...
	bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 melt) override
	{
			...
			// action = StatsCount id
		{
									 ...
									 if (invItem)
									 {
										 ...
										 player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TALK, "Retour..", 0, Melt(SELECT_STAT_REDUCE, invItem->GetSlot()));
										 player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
									 }
									 else
									 {
		...
		case RESTORE:
			// sender = item guidlow
		{
						Item* invItem = player->GetItemByGuid((HIGHGUID_ITEM, 0, sender));
						{
